...
const ASSET_TYPES_RAW: readonly { keyword: string; label: string }[] = [
  ...
  { keyword: "bicycle parking", label: "Bicycle Parking" },
  { keyword: "drinking water", label: "Drinking Water Fountains" },
  { keyword: "public toilets", label: "Public Toilets" },
  { keyword: "benches", label: "Benches" },
  { keyword: "piers", label: "Piers" },
  { keyword: "jetties", label: "Jetties" },
  { keyword: "slipways", label: "Slipways" },
  { keyword: "moorings", label: "Moorings" },
  { keyword: "cable cars", label: "Cable Cars" },
  { keyword: "gondolas", label: "Gondolas" },
  { keyword: "funiculars", label: "Funiculars" },
  { keyword: "chairlifts", label: "Chairlifts" },
  { keyword: "battery storage", label: "Battery Storage" },
  { keyword: "street lamps", label: "Street Lamps" },
  { keyword: "traffic signals", label: "Traffic Signals" },
  { keyword: "sirens", label: "Emergency Sirens" },
  { keyword: "defibrillators", label: "Defibrillators" },
  { keyword: "tourist information", label: "Tourist Information" },
  { keyword: "picnic sites", label: "Picnic Sites" },
  { keyword: "supermarkets", label: "Supermarkets" },
  { keyword: "shopping malls", label: "Shopping Malls" },
  { keyword: "marketplaces", label: "Marketplaces" },
  { keyword: "bike sharing", label: "Bike Sharing" },
  { keyword: "car sharing", label: "Car Sharing" },
  { keyword: "planetariums", label: "Planetariums" },
  { keyword: "laboratories", label: "Laboratories" },
  { keyword: "construction sites", label: "Construction Sites" },
  { keyword: "wineries", label: "Wineries" },
  { keyword: "bakeries", label: "Bakeries" },
  { keyword: "dairies", label: "Dairies" },
  { keyword: "taxi stands", label: "Taxi Stands" },
  { keyword: "car washes", label: "Car Washes" },
  { keyword: "post boxes", label: "Post Boxes" },
  { keyword: "public telephones", label: "Public Telephones" },
  { keyword: "community centres", label: "Community Centres" },
  { keyword: "shelters", label: "Shelters" },
  { keyword: "restaurants", label: "Restaurants" },
  { keyword: "cafes", label: "Cafes" },
  { keyword: "fast food", label: "Fast Food" },
  { keyword: "playgrounds", label: "Playgrounds" },
  { keyword: "parks", label: "Parks" },
  { keyword: "sports pitches", label: "Sports Pitches" },
  { keyword: "fountains", label: "Fountains" },
  { keyword: "waterfalls", label: "Waterfalls" },
  { keyword: "hot springs", label: "Hot Springs" },
  { keyword: "monitoring stations", label: "Monitoring Stations" },
  { keyword: "weather stations", label: "Weather Stations" },
] as const;
